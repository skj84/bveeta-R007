...
LoginWidget::LoginWidget(QWidget *parent)
  ...
  connect(ui->pushButton_return, &QPushButton::clicked, [=]() {
    QMessageBox msg(this);                  //Dialog settings parent component
    msg.setWindowTitle("Back to Home page");       //Dialog title
    msg.setText("Whether to save settings");            //Dialog prompt text
